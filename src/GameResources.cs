...
namespace MyGame
{
	...
	public static class GameResources
	{
		...
		private static void FreeFonts()
		{
			...
			//foreach (obj in _Fonts.Values) original; gives warning on 'in' saying it's not expected, trying new version instead
		...
		private static void FreeImages()
		{
			...
			//foreach (obj in _Images.Values) original; gives warning on 'in' saying it's not expected, trying new version instead
		...
		private static void FreeSounds()
		{
			...
			//foreach (obj in _Sounds.Values) original; gives warning on 'in' saying it's not expected, trying new version instead
		...
		private static void FreeMusic()
		{
			...
			//foreach (obj in _Music.Values) original; gives warning on 'in' saying it's not expected, trying new version instead
