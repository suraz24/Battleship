...
public static class GameController
{
	...
	{
		//Check if is there an old game that did not close
		if (_theGame != null)
			EndGame();
		...
		switch (_aiSetting) {
			...
			case AIOption.Hard:
				...
				break;
			default:
				_ai = new AIHardPlayer(_theGame); //Doesn't not mentions the easy AI
				break;
		}
	...
	private static void AttackCompleted(object sender, AttackResult result)
	{
		...
		//Display animation and sound effect based on the case
		switch (result.Value) {
