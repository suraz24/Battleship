...
public class AttackResult
{
	...
	/// </summary>
	/// <value>The row where the attack occured</value>
	/// <returns>The row where the attack occured</returns>
	public int Row {
		get { return _Row; }
	}
	...
	/// </summary>
	/// <value>The column where the attack occurred</value>
	/// <returns>The column where the attack occurred</returns>
	public int Column {
		get { return _Column; }
	}
