...
public class Ship
{
	...
	/// <returns>The direction the ship is facing</returns>
	...
	/// Builds a ship?
	/// </summary>
	/// <param name="ship">passed in ship to build?</param>
	...
	/// <summary>
	/// Increments the hitstaken variable
	/// </summary>
	public void Hit()
	{
	...
	/// <summary>
	/// IsDestroyed returns if each tile a ship is on has been hit
	/// </summary>
